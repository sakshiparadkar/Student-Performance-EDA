...
- Evaluate statistical measures (Mean, Median, Mode)
- Assess distribution symmetry using Skewness
...
- Academic score variables show near-symmetric distributions.
- Strong positive correlation observed among subject scores.
